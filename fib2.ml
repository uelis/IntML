...
let rec apply181(x1071) = let x1076, x1071 = x1071 in match x1071 with Inl(x1075) -> apply179 (x1076, x1075) | Inr(x1075) -> apply180 (x1076, x1075)
and apply180(_,Inr(x1065)) = print_int x1065 (* apply0 x1065 *)
and apply179(x1064, x1059) = let x1062, x1063 = x1059 in apply5 ((x1064, x1062), x1063)
and apply178(x1058, x1057) = apply1 (x1058, (Inl x1057))
and apply177(x1052, x1047) = let x1050, x1051 = x1047 in apply175 ((x1052, x1050), x1051)
and apply176(x1046, x1041) = let x1044, x1045 = x1041 in apply10 (x1046, x1045)
...
and apply174(x1029, x1033) = let x1034, x1032 = x1029 in apply176 (x1034, (x1032, x1033))
and apply173(x1028, x1027) = let x1026, x1027 = x1027 in match x1026 with Inl(x1026) -> apply171 (x1028, (x1026, x1027)) | Inr(x1025) -> apply169 (x1028, (x1025, x1027))
and apply172(x1022, x1017) = let x1020, x1021 = x1017 in apply174 (x1022, x1021)
and apply171(x1016, x1011) = let x1014, x1015 = x1011 in apply31 ((x1016, x1014), x1015)
and apply170(x1010, x1009) = let x1008, x1006 = x1009 in apply172 (x1010, ((Inl x1008), x1006))
and apply169(x1004, x999) = let x1002, x1003 = x999 in apply167 ((x1004, x1002), x1003)
and apply168(x998, x997) = let x995, x994 = x997 in apply172 (x998, ((Inr x995), x994))
...
and apply51(x301) = 
  let x306, x305 = x301 in 
    apply50 (x306, 
             ((let x306, yfalse = x306 in 
               let x306, yv = x306 in 
               let x306, y_un = x306 in 
                 fun yx -> 
                   match yx with 
                     Inl(ylx) -> 
                       let yl, yx = ylx in 
                         (match yx with 
                             Inl(ybq) -> 
                               let yb, yq = ybq in 
                                 (Inl (yb:: yl, (Inr yq))) 
                           | Inr(ya) -> 
                               (match (listcase yl) with 
                                   Inl(ynl) -> (Inr ya) 
                                 | Inr(ycns) -> 
                                     let yhd, ytl = ycns in (Inl (ytl, (Inl (yhd, ya))))))
                   | Inr(yq) -> (Inl ([], (Inr yq)))) 
                x305))
and apply50(x295) = let x300, x295 = x295 in match x295 with Inl(x299) -> apply129 (x300, x299) | Inr(x299) -> apply130 (x300, x299)
and apply49(x289) = let x294, x289 = x289 in match x289 with Inl(x293) -> apply46 (x294, x293) | Inr(x293) -> apply131 (x294, x293)
and apply48(x283) = let x288, x283 = x283 in match x283 with Inl(x287) -> apply147 (x288, x287) | Inr(x287) -> apply148 (x288, x287)
and apply47(x277) = let x282, x281 = x277 in apply48 (x282, (Inl x281))
and apply46(x271) = let x276, x272 = x271 in let x274, x275 = x272 in apply54 (x276, ((fun x -> x) x274, x275))
and apply45(x265) = let x270, x269 = x265 in let x267, x266 = x269 in apply41 (x270, ((Inr x267), x266))
and apply44(x259) = let x264, x260 = x259 in let x262, x263 = x260 in apply152 (x264, ((fun x -> x) x262, x263))
and apply43(x253) = let x258, x257 = x253 in let x256, x254 = x257 in apply41 (x258, ((Inl x256), x254))
and apply42(x247) = let x252, x248 = x247 in let x250, x251 = x248 in apply134 (x252, ((fun x -> x) x250, x251))
and apply41(x241) = let x246, x241 = x241 in let x244, x245 = x241 in apply37 ((x246, x244), x245)
and apply40(x235) = let x240, x239 = x235 in let x238, x239 = x239 in match x238 with Inl(x238) -> apply42 (x240, (x238, x239)) | Inr(x237) -> apply44 (x240, (x237, x239))
and apply39(x229) = let x234, x230 = x229 in let x232, x233 = x230 in apply33 (x234, ((fun x -> x) x232, x233))
and apply38(x223) = let x228, x223 = x223 in let x226, x227 = x223 in apply36 (x228, x227)
and apply37(x217) = let x222, x221 = x217 in apply39 (x222, ((let x222, y_un = x222 in let x222, yfalse = x222 in let x222, yv = x222 in let x222, _un = x222 in min), x221))
and apply36(x211) = let x211, x215 = x211 in let x216, x214 = x211 in apply40 (x216, (x214, x215))
and apply35(x205) = let x210, x206 = x205 in let x208, x209 = x206 in apply27 (x210, ((fun x -> x) x208, x209))
and apply34(x199) = let x204, x199 = x199 in let x199, x203 = x199 in let x201, x202 = x199 in apply32 ((x204, x201), (x202, x203))
and apply33(x193) = let x193, x194 = x193 in let x198, x195 = x193 in let x196, x197 = x194 in apply35 (x198, ((x195, x196), x197))
and apply32(x187) = let x192, x188 = x187 in let x190, x191 = x188 in apply38 (x192, ((fun x -> x) x190, x191))
and apply31(x181) = let x186, x185 = x181 in apply30 (x186, ((let x186, ytrue = x186 in let x186, yv = x186 in let x186, y_un = x186 in fun y_un -> succ zero) x185))
and apply30(x175) = let x175, x179 = x175 in let x180, x178 = x175 in apply170 (x180, (x178, x179))
and apply29(x174) = bot ()
and apply28(x168) = bot ()
and apply27(x162) = let x162, x166 = x162 in let x167, x165 = x162 in apply21 (x167, (x165, x166))
and apply26(x156) = let x161, x157 = x156 in let x159, x160 = x157 in apply34 (x161, ((fun x -> x) x159, x160))
and apply25(x150) = let x155, x150 = x150 in let x153, x154 = x150 in apply17 (x155, x154)
and apply24(x144) = let x149, x148 = x144 in let x147, x148 = x148 in match x147 with Inl(x147) -> apply22 (x149, (x147, x148)) | Inr(x146) -> apply20 (x149, (x146, x148))
and apply23(x138) = let x143, x142 = x138 in let x141, x139 = x142 in apply25 (x143, ((Inl x141), x139))
and apply22(x132) = let x137, x132 = x132 in let x135, x136 = x132 in apply28 ((x137, x135), x136)
and apply21(x126) = let x131, x130 = x126 in let x128, x127 = x130 in apply25 (x131, ((Inr x128), x127))
and apply20(x120) = let x125, x120 = x120 in let x123, x124 = x120 in apply26 ((x125, x123), x124)
and apply19(x114) = let x119, x115 = x114 in let x117, x118 = x115 in apply3 (x119, ((fun x -> x) x117, x118))
and apply18(x108) = let x113, x108 = x108 in let x108, x112 = x108 in let x110, x111 = x108 in apply16 ((x113, x110), (x111, x112))
and apply17(x102) = let x102, x103 = x102 in let x107, x104 = x102 in let x105, x106 = x103 in apply19 (x107, ((x104, x105), x106))
and apply16(x96) = let x101, x100 = x96 in apply24 (x101, ((let x101, yv = x101 in let x101, y_un = x101 in (fun yx -> fun yy -> match yx with Inl(y_un) -> (Inl ()) | Inr(y_un) -> yy) (eq yv zero) (eq yv (succ zero))), x100))
and apply15(x90) = let x95, x91 = x90 in let x93, x94 = x91 in apply7 (x95, ((fun x -> x) x93, x94))
and apply14(x84) = let x89, x84 = x84 in let x87, x88 = x84 in apply12 (x89, x88)
and apply13(x78) = let x83, x82 = x78 in apply15 (x83, ((let x83, y_un = x83 in min), x82))
and apply12(x72) = let x77, x76 = x72 in apply177 (x77, (x76, ()))
and apply11(x66) = let x71, x70 = x66 in apply13 (x71, ())
and apply10(x60) = let x65, x64 = x60 in apply8 (x65, (Inr x64))
and apply9(x54) = let x59, x54 = x54 in match x54 with Inl(x58) -> apply6 (x59, x58) | Inr(x58) -> apply11 (x59, x58)
and apply8(x48) = let x53, x52 = x48 in apply4 (x53, (Inr x52))
and apply7(x42) = let x47, x46 = x42 in apply8 (x47, (Inl x46))
and apply6(x36) = let x41, x37 = x36 in let x39, x40 = x37 in apply14 (x41, ((fun x -> x) x39, x40))
and apply5(x30) = let x35, x30 = x30 in match x30 with Inl(x34) -> apply2 (x35, x34) | Inr(x34) -> apply9 (x35, x34)
and apply4(x24) = let x24, x28 = x24 in let x29, x27 = x24 in apply178 (x29, (x27, x28))
and apply3(x18) = let x23, x22 = x18 in apply4 (x23, (Inl x22))
and apply2(x12) = let x17, x13 = x12 in let x15, x16 = x13 in apply18 (x17, ((fun x -> x) x15, x16))
and apply1(x6) = let x11, x10 = x6 in apply181 (x11, 
                                                ((fun yx -> 
                                                    match yx with 
                                                        Inl(ylx) -> 
                                                          let yl, yx = ylx in 
                                                            (match yx with 
                                                                Inl(ybq) -> 
                                                                  let yb, yq = ybq in (Inl (yb:: yl, (Inr yq))) 
                                                              | Inr(ya) -> 
                                                                  (match (listcase yl) with 
                                                                      Inl(ynl) -> (Inr ya) 
                                                                    | Inr(ycns) -> 
                                                                        let yhd, ytl = ycns in (Inl (ytl, (Inl (yhd, ya))))))
                                                      | Inr(yq) -> (Inl ([], (Inr yq)))) x10))
and apply0(x0) = let x5, x4 = x0 in apply1 (x5, (Inr x4))

let test = apply0((), Inl((),25))
